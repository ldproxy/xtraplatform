...
@Whiteboards(whiteboards = {
        ...
        @Wbp(
                filter = "(objectClass=de.ii.xtraplatform.entities.domain.EntityHydrator)",
                onArrival = "onHydratorArrival",
                onDeparture = "onHydratorDeparture"),
        @Wbp(
                filter = "(objectClass=de.ii.xtraplatform.entities.domain.EntityMigration)",
                onArrival = "onMigrationArrival",
                onDeparture = "onMigrationDeparture"),
        @Wbp(
                filter = "(objectClass=de.ii.xtraplatform.entities.domain.EntityDataDefaults)",
...
public class EntityFactoryImpl implements EntityFactory {
    ...
    protected EntityFactoryImpl(@Context BundleContext context,
