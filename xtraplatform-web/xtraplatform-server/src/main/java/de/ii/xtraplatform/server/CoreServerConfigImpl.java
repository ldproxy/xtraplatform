...
@LocalBundleConfig(category = "Webserver", properties = {
        @ConfigPropertyDescriptor(name = CoreServerConfigImpl.EXTERNAL_URL, label = "External URL", defaultValue = "http://localhost:7080/rest/services", uiType = ConfigPropertyDescriptor.UI_TYPE.URL),
