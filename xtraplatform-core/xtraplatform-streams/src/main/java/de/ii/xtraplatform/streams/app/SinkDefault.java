...
public class SinkDefault<U, V> implements Sink<U, V> {
  ...
  public enum Type {IGNORE, HEAD, SUBSCRIBER, FOREACH, REDUCE, OUTPUT_STREAM}
  ...
  SinkDefault(Type type, Flow.Subscriber<U> subscriber, Consumer<U> consumer, V item,
      BiFunction<V, U, V> reducer, OutputStream outputStream) {
    this.type = type;
