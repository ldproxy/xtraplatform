...
public class StreamExecutorServiceConfigurator extends ExecutorServiceConfigurator {
  ...
  public ExecutorServiceFactory createExecutorServiceFactory(
      String id, ThreadFactory threadFactory) {
  ...
  class MyForkJoinPool implements ExecutorService, LoadMetrics {
    ...
    // TODO: is this really needed? otherwise we can remove MyForkJoinPool +
    // MyExecutorServiceFactory
    @Override
  ...
  class MyExecutorServiceFactory implements ExecutorServiceFactory {
    ...
    public ExecutorService createExecutorService() {
      ForkJoinExecutorConfigurator.AkkaForkJoinPool akkaForkJoinPool =
          (ForkJoinExecutorConfigurator.AkkaForkJoinPool) delegate.createExecutorService();
